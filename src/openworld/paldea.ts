...
export const PALDEA_LOCATIONS:readonly KantoLocation[]=[
  ...
  l('south-province-area-two','남부 에리어 2',-58,27,'route',[8,16]),l('cortondo','세르클마을',-72,17,'town',[12,20]),l('west-province-area-one','서부 에리어 1',-52,3,'route',[14,24],2),l('cascarrafa','카라프시티',-31,-5,'town',[18,28],3),
  l('west-province-area-two','서부 에리어 2',-13,-22,'route',[25,38],4),l('medali','참푸르마을',3,-32,'town',[30,42],4),l('casseroya-lake','오야호수',-9,-52,'sea',[40,55],5),
  l('east-province-area-one','동부 에리어 1',-20,29,'route',[16,26],1),l('artazon','보울마을',-4,19,'town',[17,27],1),l('east-province-area-two','동부 에리어 2',14,9,'sea',[20,32],2),l('levincia','누룩스시티',31,2,'town',[24,35],2),
  ...
  l('south-province-area-six','남부 에리어 6',7,30,'cave',[42,56],6),l('alfornada','베이크마을',25,43,'town',[44,57],6),l('paldea-pokemon-league','팔데아 포켓몬리그',-28,53,'special',[52,68],8),
  l('area-zero','에리어 제로',56,27,'special',[55,70],8),
  l('grasswither-shrine','총지엔의 사당',23,-23,'special',[60,70],8),l('icerend-shrine','파오젠의 사당',62,-67,'special',[60,70],8),
  l('groundblight-shrine','딩루의 사당',-20,-33,'special',[60,70],8),l('firescourge-shrine','위유이의 사당',-65,38,'special',[60,70],8),
];
export const PALDEA_CONNECTIONS:ReadonlyArray<readonly[string,string]>=[
  ...
  ['tagtree-thicket','grasswither-shrine'],['glaseado-mountain','icerend-shrine'],['west-province-area-two','groundblight-shrine'],['south-province-area-two','firescourge-shrine'],
];
...
const runtime=createAuthoredRegionSampler({id:'paldea',locations:PALDEA_LOCATIONS,connections:PALDEA_CONNECTIONS,terrainFeatures:[
  {locationId:'glaseado-mountain',surface:'snow',radius:14,elevation:.7},
  {locationId:'montenevera',surface:'snow',radius:9,elevation:.45},
  // The Asado Desert spreads west of Cascarrafa.
  {locationId:'west-province-area-one',surface:'desert',radius:12,elevation:.3},
  {locationId:'cascarrafa',surface:'desert',radius:8,elevation:.2},
]});
export const PALDEA_GATES:readonly KantoGate[]=terrainProgressGates(PALDEA_LOCATIONS,PALDEA_CONNECTIONS,runtime.locationAt,PALDEA_GYMS,'배지');
