...
export const DUNGEON_PLANS: readonly DungeonPlan[] = [
  ...
  room('ruins', 'stone', { regionId: 'paldea', id: 'area-zero', name: '에리어 제로', label: 'Area Zero', seed: 499, width: 19, depth: 15, surfaceLocations: ['area-zero'], legendary: [1007, 1008] }, [floor('1f')]),
  ...
  room('ruins', 'stone', { regionId: 'alola', id: 'altar-of-the-sunne', name: '일륜의제단', label: 'Altar of the Sunne', seed: 631, width: 15, depth: 13, surfaceLocations: ['altar-of-the-sunne'], legendary: [791], levels: [55, 65] }, [floor('1f', undefined, { locationId: 'vast-poni-canyon' })]),
  ...
  room('ruins', 'stone', { regionId: 'galar', id: 'slumbering-weald', name: '꾸벅졸음숲 안쪽', label: 'Slumbering Weald', seed: 661, width: 17, depth: 15, surfaceLocations: ['slumbering-weald'], legendary: [888, 889] }, [floor('1f', ['main']), floor('b1f', ['deep'])]),
  room('plant', 'industrial', { regionId: 'galar', id: 'energy-plant', name: '에너지플랜트', label: 'Energy Plant', seed: 673, width: 23, depth: 17, surfaceLocations: ['energy-plant'], legendary: [890], levels: [60, 70] },
    [floor('1f', undefined, { locationId: 'galar-route-6' }), floor('2f', undefined, { locationId: 'galar-route-6' })]),
  room('ruins', 'stone', { regionId: 'galar', id: 'split-decision-ruins', name: '결단의유적', label: 'Split-Decision Ruins', seed: 677, width: 15, depth: 13, surfaceLocations: ['split-decision-ruins'], legendary: [894, 895], levels: [55, 65] }, [floor('1f', undefined, { locationId: 'galar-route-8' })]),
  ...
  cave({ regionId: 'hisui', id: 'hisui-valor-cavern', name: '입지호수 동굴', label: 'Valor Cavern', seed: 691, width: 17, depth: 13, silhouette: 'rounded', surfaceLocations: ['hisui-valor-cavern'], legendary: [482], levels: [60, 70] }, [floor('1f', undefined, { locationId: 'crimson-mirelands' })]),
  ...
  cave({ regionId: 'hisui', id: 'hisui-turnback-cave', name: '돌아오는동굴', label: 'Turnback Cave', seed: 727, width: 21, depth: 19, silhouette: 'rounded', surfaceLocations: ['hisui-turnback-cave'], legendary: [487], levels: [65, 75] },
    [floor('1f', undefined, { locationId: 'coronet-highlands' }), floor('b1f', undefined, { locationId: 'coronet-highlands' })]),
  room('ruins', 'stone', { regionId: 'paldea', id: 'grasswither-shrine', name: '총지엔의 사당', label: 'Grasswither Shrine', seed: 733, width: 13, depth: 11, surfaceLocations: ['grasswither-shrine'], legendary: [1001], levels: [60, 70] }, [floor('1f', undefined, { locationId: 'tagtree-thicket' })]),
  room('ruins', 'stone', { regionId: 'paldea', id: 'icerend-shrine', name: '파오젠의 사당', label: 'Icerend Shrine', seed: 739, width: 13, depth: 11, surfaceLocations: ['icerend-shrine'], legendary: [1002], levels: [60, 70] }, [floor('1f', undefined, { locationId: 'glaseado-mountain' })]),
  room('ruins', 'stone', { regionId: 'paldea', id: 'groundblight-shrine', name: '딩루의 사당', label: 'Groundblight Shrine', seed: 743, width: 13, depth: 11, surfaceLocations: ['groundblight-shrine'], legendary: [1003], levels: [60, 70] }, [floor('1f', undefined, { locationId: 'west-province-area-two' })]),
  room('ruins', 'stone', { regionId: 'paldea', id: 'firescourge-shrine', name: '위유이의 사당', label: 'Firescourge Shrine', seed: 751, width: 13, depth: 11, surfaceLocations: ['firescourge-shrine'], legendary: [1004], levels: [60, 70] }, [floor('1f', undefined, { locationId: 'south-province-area-two' })]),
  room('ruins', 'stone', { regionId: 'sinnoh', id: 'spear-pillar', name: '창기둥', label: 'Spear Pillar', seed: 557, width: 15, depth: 15, surfaceLocations: ['spear-pillar'], legendary: [483, 484], levels: [55, 65] }, [floor('1f', ['exterior-snowfall', 'exterior-blizzard'], { locationId: 'mt-coronet' })]),
  ...
  cave({ regionId: 'sinnoh', id: 'verity-cavern', name: '진실호수 동굴', label: 'Verity Cavern', seed: 577, width: 17, depth: 13, silhouette: 'rounded', surfaceLocations: ['verity-cavern'], legendary: [481], levels: [45, 55] }, [floor('1f', ['after-galactic-intervention'], { locationId: 'lake-verity' })]),
  cave({ regionId: 'sinnoh', id: 'acuity-cavern', name: '예지호수 동굴', label: 'Acuity Cavern', seed: 587, width: 17, depth: 13, silhouette: 'rounded', surfaceLocations: ['acuity-cavern'], legendary: [480], levels: [45, 55] }, [floor('1f', undefined, { locationId: 'lake-acuity' })]),
  cave({ regionId: 'sinnoh', id: 'valor-cavern', name: '입지호수 동굴', label: 'Valor Cavern', seed: 593, width: 17, depth: 13, silhouette: 'rounded', surfaceLocations: ['valor-cavern'], legendary: [482], levels: [45, 55] }, [floor('1f', undefined, { locationId: 'sinnoh-route-214' })]),
  ...
  cave({ regionId: 'unova', id: 'mistralton-cave', name: '궐수동굴', label: 'Mistralton Cave', seed: 607, width: 21, depth: 17, silhouette: 'bend', surfaceLocations: ['mistralton-cave'], legendary: [638, 640], levels: [45, 55] }, [floor('1f', ['']), floor('2f', ['']), floor('3f', [''])]),
  room('tower', 'stone', { regionId: 'hoenn', id: 'sky-pillar', name: '하늘기둥', label: 'Sky Pillar', seed: 503, width: 14, depth: 14, surfaceLocations: ['sky-pillar'], legendary: [384], levels: [50, 60] }, tower(5, ['1f', '3f', '5f'])),
  ...
  room('ruins', 'stone', { regionId: 'hoenn', id: 'southern-island', name: '남쪽외딴섬', label: 'Southern Island', seed: 547, width: 13, depth: 11, surfaceLocations: ['southern-island'], legendary: [380, 381], levels: [45, 55] }, [floor('1f', undefined, { locationId: 'hoenn-route-121' })]),
];
