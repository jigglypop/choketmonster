...
export const SINNOH_LOCATIONS: readonly KantoLocation[] = [
  l('twinleaf-town','떡잎마을',-72,78,'town',[2,4]), l('sinnoh-route-201','201번도로',-62,66,'route',[2,5]), l('lake-verity','진실호수',-82,61,'sea',[3,6]),
  ...
  l('sinnoh-route-207','207번도로',0,15,'route',[8,15]), l('mt-coronet','천관산',15,0,'cave',[12,38]), l('sinnoh-route-208','208번도로',0,-12,'route',[12,20]),
  l('hearthome-city','연고시티',-18,-12,'town',[16,25]), l('sinnoh-route-209','209번도로',-3,-28,'route',[16,25]), l('solaceon-town','신수마을',11,-38,'town',[18,28]),
  l('sinnoh-route-210','210번도로',11,-55,'route',[20,31]), l('celestic-town','봉신마을',-8,-64,'town',[22,34]), l('sinnoh-route-211','211번도로',12,-64,'route',[22,35]),
  l('eterna-city','영원시티',-45,-34,'town',[14,23]), l('eterna-forest','영원의숲',-58,-21,'forest',[10,19]), l('sinnoh-route-205','205번도로',-48,-7,'route',[9,18]),
  l('floaroma-town','꽃향기마을',-61,5,'town',[8,16]), l('sinnoh-route-204','204번도로',-54,18,'route',[6,13]), l('sinnoh-route-206','206번도로',-31,-20,'route',[12,22]),
  l('sinnoh-route-212','212번도로',-18,8,'route',[18,30]), l('pastoria-city','들판시티',-5,18,'town',[22,34]), l('sinnoh-route-213','213번도로',14,28,'route',[23,35]),
  l('sinnoh-route-214','214번도로',31,10,'route',[24,36]), l('veilstone-city','장막시티',31,-12,'town',[24,37]), l('sinnoh-route-215','215번도로',15,-25,'route',[24,37]),
  l('sinnoh-route-216','216번도로',31,-45,'route',[28,42]), l('sinnoh-route-217','217번도로',42,-63,'route',[30,45]), l('snowpoint-city','선단시티',56,-72,'town',[32,48]),
  l('lake-acuity','예지호수',70,-66,'sea',[34,50]), l('sinnoh-route-222','222번도로',58,12,'route',[32,46]), l('sunyshore-city','물가시티',76,12,'town',[35,50]),
  l('sinnoh-sea-route-223','223번수로',87,-6,'sea',[38,54]), l('sinnoh-victory-road','챔피언로드',91,-27,'cave',[42,58],8), l('sinnoh-pokemon-league','포켓몬리그',91,-45,'special',[50,65],8),
  l('sinnoh-route-218','218번도로',-68,32,'route',[18,30]), l('canalave-city','운하시티',-88,32,'town',[26,40]), l('iron-island','강철섬',-100,8,'cave',[30,45]),
];
...
export const SINNOH_GATES: readonly KantoGate[] = []; export const SINNOH_GYMS: readonly KantoGym[] = [
