...
export const HISUI_LOCATIONS:readonly KantoLocation[]=[
  ...
  l('mirelands-camp','습지 기지',-25,47,'town',[16,25],1),l('crimson-mirelands','홍련 습지',-8,35,'sea',[18,28],1),l('brava-arena','무대의 전장',5,24,'special',[24,32],2),
  l('coastlands-camp','해안 기지',-5,3,'town',[25,34],2),l('cobalt-coastlands','군청 해안',15,8,'sea',[28,38],2),l('molten-arena','용암의 전장',31,16,'special',[32,42],3),
  l('highlands-camp','산기슭 기지',14,-18,'town',[34,44],3),l('coronet-highlands','천관산 기슭',29,-28,'cave',[38,50],4),l('moonview-arena','영월의 전장',45,-21,'special',[43,54],5),
  l('icelands-camp','동토 기지',43,-50,'town',[46,58],5),l('alabaster-icelands','순백 동토',60,-56,'route',[48,60],6),l('icepeak-arena','빙산의 전장',75,-48,'special',[52,64],7),
  l('temple-of-sinnoh','신오신전',84,-72,'special',[58,70],8),
];
...
export const HISUI_GATES:readonly KantoGate[]=[];
