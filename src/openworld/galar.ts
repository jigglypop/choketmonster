...
export const GALAR_LOCATIONS: readonly KantoLocation[] = [
  ...
  l('hulbury','바우마을',-34,-31,'town',[20,29],1), l('south-lake-miloch','밀로틱호 남쪽',-14,-18,'sea',[11,20]), l('bridge-field','다리아래 벌판',2,-15,'route',[20,32],2),
  ...
  l('galar-route-10','10번도로',72,-5,'route',[46,60],7), l('wyndon','슛시티',78,18,'town',[50,64],8), l('galar-pokemon-league','챔피언컵',88,31,'special',[55,70],8),
];
