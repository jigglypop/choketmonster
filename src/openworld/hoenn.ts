...
// Badges follow Emerald: Mr. Briney's boat (1), Slateport and Mauville (2), Rock Smash north of Mauville (3),
// Surf across Route 118 and between Dewford and Littleroot (5), the Devon Scope on Route 120 and the sea from
// Lilycove to Pacifidlog (6), Dive into Sootopolis (7), Waterfall to Victory Road (8). Traversal follows
// nearest-place cells: those of Routes 108 and 134 cover part of Littleroot Town and Route 101, so both open at the start.
export const HOENN_LOCATIONS: readonly KantoLocation[] = [
  ...
  l('hoenn-route-105', '105번수로', -101, 45, 'sea', [5, 10], 1), l('hoenn-route-106', '106번수로', -105, 61, 'sea', [6, 12], 1),
  l('dewford-town', '무로마을', -94, 72, 'town', [7, 14], 1), l('granite-cave', '바위동굴', -105, 76, 'cave', [8, 15], 1),
  l('hoenn-route-107', '107번수로', -74, 78, 'sea', [8, 16], 5), l('hoenn-route-108', '108번수로', -48, 82, 'sea', [9, 18]), l('hoenn-route-109', '109번수로', -10, 67, 'sea', [10, 20], 6),
  l('petalburg-woods', '등화숲', -82, 23, 'forest', [5, 9]), l('rustboro-city', '금탄도시', -74, 8, 'town', [7, 12]),
  l('hoenn-route-116', '116번도로', -53, 8, 'route', [7, 12]), l('rusturf-tunnel', '금잔터널', -34, 8, 'cave', [8, 13], 1),
  l('verdanturf-town', '잔디마을', -15, 8, 'town', [10, 16], 2), l('hoenn-route-117', '117번도로', 4, 8, 'route', [12, 18], 2),
  l('mauville-city', '보라시티', 24, 8, 'town', [14, 22], 2), l('hoenn-route-110', '110번도로', 24, 29, 'route', [12, 18], 2),
  l('slateport-city', '잿빛도시', 24, 48, 'town', [14, 22], 2), l('hoenn-route-103', '103번도로', -30, 48, 'route', [3, 6]),
  l('hoenn-route-111', '111번도로', 24, -12, 'route', [15, 24], 3), l('hoenn-route-112', '112번도로', 7, -24, 'route', [16, 25], 3),
  l('fiery-path', '불꽃샛길', 3, -36, 'cave', [16, 26], 3), l('lavaridge-town', '용암마을', -8, -28, 'town', [18, 28], 3),
  l('hoenn-route-113', '113번도로', 10, -52, 'route', [18, 28], 3), l('fallarbor-town', '단풍마을', -12, -58, 'town', [20, 30], 3),
  l('hoenn-route-114', '114번도로', -36, -46, 'route', [20, 31], 3), l('meteor-falls', '유성폭포', -58, -38, 'cave', [20, 33], 3),
  l('hoenn-route-115', '115번도로', -70, -18, 'route', [21, 34]), l('hoenn-route-118', '118번도로', 43, 8, 'route', [22, 34], 2),
  l('hoenn-route-119', '119번도로', 49, -13, 'forest', [23, 35], 5), l('fortree-city', '검방울시티', 49, -34, 'town', [24, 36], 5),
  l('hoenn-route-120', '120번도로', 65, -24, 'route', [25, 38], 6), l('hoenn-route-121', '121번도로', 80, -10, 'route', [26, 39], 6),
  l('lilycove-city', '해안시티', 92, -5, 'town', [28, 42], 6), l('hoenn-route-124', '124번수로', 91, 20, 'sea', [30, 44], 6),
  l('mossdeep-city', '이끼시티', 82, 36, 'town', [32, 45], 6), l('hoenn-route-126', '126번수로', 64, 48, 'sea', [32, 46], 6),
  l('sootopolis-city', '루네시티', 61, 35, 'town', [34, 48], 7), l('hoenn-route-127', '127번수로', 82, 54, 'sea', [34, 48], 6),
  l('hoenn-route-128', '128번수로', 91, 68, 'sea', [35, 50], 6), l('hoenn-victory-road', '챔피언로드', 100, 77, 'cave', [40, 55], 8),
  l('ever-grande-city', '그랜드시티', 108, 86, 'town', [45, 60], 8), l('hoenn-route-129', '129번수로', 70, 74, 'sea', [34, 50], 6),
  l('hoenn-route-130', '130번수로', 47, 74, 'sea', [34, 50], 6), l('hoenn-route-131', '131번수로', 24, 74, 'sea', [34, 50], 6),
  l('pacifidlog-town', '황금마을', 2, 74, 'town', [34, 50], 6), l('hoenn-route-132', '132번수로', -17, 74, 'sea', [34, 50], 6),
  l('hoenn-route-133', '133번수로', -35, 70, 'sea', [34, 50], 6), l('hoenn-route-134', '134번수로', -52, 62, 'sea', [34, 50]),
  // Legendary lairs open with the eighth badge.
  l('sky-pillar', '하늘기둥', 2, 88, 'special', [50, 65], 8), l('cave-of-origin', '각성의사당', 61, 21, 'cave', [45, 60], 8),
  l('desert-ruins', '사막유적', 34, -12, 'special', [40, 55], 8), l('island-cave', '섬의동굴', -107, 69, 'cave', [40, 55], 8),
  l('ancient-tomb', '고대무덤', 65, -38, 'special', [40, 55], 8), l('southern-island', '남쪽외딴섬', 77, 3, 'special', [45, 55], 8),
];
...
export const HOENN_CONNECTIONS: ReadonlyArray<readonly [string, string]> = [
  ...
  // Littleroot's shore and Route 101 already lie in these sea cells; the links let route finding reach them.
  ['littleroot-town','hoenn-route-108'],['hoenn-route-101','hoenn-route-134'],
  ['pacifidlog-town','sky-pillar'],['sootopolis-city','cave-of-origin'],['hoenn-route-111','desert-ruins'],['dewford-town','island-cave'],['hoenn-route-120','ancient-tomb'],['hoenn-route-121','southern-island'],
];
