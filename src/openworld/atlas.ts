...
const plans: readonly AtlasPlan[] = [
  { id: 'johto', name: '성도', englishName: 'Johto', defaultVersion: 'gold', palette: { ground: '#8cc66c', water: '#5ab9d4', town: '#e3b574' }, species: [152,155,158,161,163,165,167,179,187,194,204,209,216,220,228], zones: [{ x: 55, z: -60, radius: 22, biome: 'lake' }, { x: -20, z: -35, radius: 25, biome: 'forest' }], landmarks: [
  ...
  { id: 'hoenn', name: '호연', englishName: 'Hoenn', defaultVersion: 'ruby', palette: { ground: '#7fca72', water: '#4cbfd8', town: '#eca877' }, species: [252,255,258,261,263,265,270,273,276,280,293,304,309,316,318,320,322,325], zones: [{ x: 10, z: 5, radius: 26, biome: 'rock', lift: .8 }, { x: 55, z: 50, radius: 48, biome: 'lake' }], landmarks: [
  ...
  { id: 'sinnoh', name: '신오', englishName: 'Sinnoh', defaultVersion: 'diamond', palette: { ground: '#98c585', water: '#6bb4d8', town: '#d2bd9e' }, species: [387,390,393,396,399,401,403,406,418,425,427,431,434,436,443,449,451,453,455,459], zones: [{ x: 4, z: -10, radius: 30, biome: 'rock', lift: 1.1 }, { x: -60, z: 46, radius: 20, biome: 'lake' }], landmarks: [
  ...
  { id: 'unova', name: '하나', englishName: 'Unova', defaultVersion: 'black', palette: { ground: '#88bf72', water: '#58afd0', town: '#d3b18c' }, species: [495,498,501,504,506,509,511,513,515,519,522,524,527,529,532,535,540,543,546,548,550,551,554,557,559,562,568,570,572,574], zones: [{ x: 5, z: 5, radius: 21, biome: 'lake' }, { x: 58, z: -45, radius: 24, biome: 'rock', lift: .7 }], landmarks: [
  ...
  { id: 'alola', name: '알로라', englishName: 'Alola', defaultVersion: 'sun', palette: { ground: '#98d26f', water: '#3cc6dc', town: '#f0c47f' }, species: [722,725,728,731,734,736,739,741,742,744,746,747,749,751,753,755,757,759,761,764,766,769,771,774,775,777,779,780,782], zones: [{ x: -55, z: 45, radius: 24, biome: 'lake' }, { x: 8, z: 5, radius: 24, biome: 'lake' }, { x: 62, z: -35, radius: 25, biome: 'lake' }], landmarks: [
  ...
  { id: 'galar', name: '가라르', englishName: 'Galar', defaultVersion: 'sword', palette: { ground: '#8ec473', water: '#5ab3d0', town: '#d3a08a' }, species: [810,813,816,819,821,824,827,829,831,833,835,837,840,843,845,846,848,850,852,854,856,859,868,870,872,874,875,876,877,878], zones: [{ x: 4, z: 5, radius: 28, biome: 'forest' }, { x: 40, z: -48, radius: 25, biome: 'rock', lift: .8 }], landmarks: [
  ...
  { id: 'hisui', name: '히스이', englishName: 'Hisui', defaultVersion: 'legends-arceus', palette: { ground: '#96bf74', water: '#5eb0c8', town: '#c4a684' }, species: [722,155,501,399,396,403,418,425,434,449,459,550,570,627,629,704,712], zones: [{ x: 0, z: -5, radius: 30, biome: 'rock', lift: 1 }, { x: 58, z: 18, radius: 25, biome: 'lake' }], landmarks: [
