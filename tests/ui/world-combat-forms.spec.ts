...
import { assignPreferredTransformation, assignAlolaForm, createGame, createMonster } from '../../src/game/engine';
import { defaultView, packSave } from '../../src/game/storage';
import { OpenWorldSimulation } from '../../src/openworld/simulation';
import type { Graph } from '../../src/core/brain';

test('WebGPU exploration renders Alola geometry and Mega aura', async ({ page }, info) => {
