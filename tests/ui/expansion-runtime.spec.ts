...
for (const [region, starter, label] of [['hoenn',252,'호연'],['sinnoh',387,'신오'],['unova',495,'하나']] as const) test(`${region} renders a rigged partner, starts a gym battle and restores it`, async ({ page }) => {
  ...
  Object.assign(game.campaign!, {johtoBadges:[1,2,3,4,5,6,7,8],johtoLeague:5,kantoLeague:5,expansion:{
    ...(region !== 'hoenn' ? {hoenn:{badges:[1,2,3,4,5,6,7,8],league:5}} : {}),
    ...(region === 'unova' ? {sinnoh:{badges:[1,2,3,4,5,6,7,8],league:5}} : {}),
  }});
