...
const specs = [
  ...
  { region: 'kalos', regionId: 6, candidates: ['x', 'y'], dexLimit: 721 },
  { region: 'alola', regionId: 7, candidates: ['sun', 'moon', 'ultra-sun', 'ultra-moon'], dexLimit: 809 },
  { region: 'galar', regionId: 8, candidates: ['sword', 'shield'], dexLimit: 905 },
  { region: 'paldea', regionId: 10, candidates: ['scarlet', 'violet'], dexLimit: 1025 },
] as const;
...
const text = `// Generated by scripts/generate-expansion-encounters.ts. Do not edit by hand.\n`
  + `export type ExpansionRegion = 'hoenn' | 'sinnoh' | 'unova' | 'kalos' | 'alola' | 'galar' | 'paldea';\n`
